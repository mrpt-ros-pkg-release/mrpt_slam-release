Name:           ros-kinetic-mrpt-rbpf-slam
Version:        0.1.1
Release:        0%{?dist}
...
%description
This package uses for gridmap SLAM. The interface is similar to gmapping
(http://wiki.ros.org/gmapping) but supports different particle-filter
algorithms, several grid maps at different heights, range-only SLAM, etc.
